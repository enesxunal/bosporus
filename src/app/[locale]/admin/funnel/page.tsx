    ...
    <div className="space-y-5 sm:space-y-6">
          ...
          <Card className="!rounded-2xl overflow-hidden" padding="none">
            <div className="border-b border-bosporus-gray-100 p-4 sm:p-6">
              <div className="flex items-center gap-2">
                ...
                <h2 className="font-extrabold text-metro-navy">{t("title")}</h2>
              </div>
            </div>
                ...
                return (
                  <div key={stage.key}>
                    {previous && (() => {
                      ...
                      return (
                        <div className="flex items-center gap-3 py-2.5 pl-4 sm:pl-6">
                    ...
                    <div className="relative overflow-hidden rounded-2xl border border-bosporus-gray-100 bg-bosporus-gray-50">
                      <div
      ...
      <div className="flex flex-col gap-1 text-xs text-bosporus-muted sm:flex-row sm:items-center sm:justify-between">
        ...
        {generatedAt && (
          <p>
            {t("lastUpdated", {
              time: new Intl.DateTimeFormat(locale === "tr" ? "tr-TR" : "de-DE", {
                dateStyle: "short",
                timeStyle: "short",
